...
public class PessoaController {
    ...
    public ResponseEntity<List<Pessoa>> obterPessoa() {
    ...
    public ResponseEntity<Object> putEndereco(@PathVariable(value = "id") long id,
            @Valid @RequestBody Endereco endereco) {
        return service.addEndereco(id, endereco);
    }
